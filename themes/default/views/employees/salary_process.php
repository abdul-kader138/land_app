...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('salary_process'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("employees/salary_process", $attrib);
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <?= lang("salary_start_date", "salary_start_date"); ?>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <?= lang("salary_end_date", "salary_end_date"); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="well well-sm">
                            <a href="<?php echo $this->config->base_url(); ?>assets/csv/sample_salary_process.csv"
                            ...
                            <?php echo $this->lang->line("csv2"); ?> <span
                                class="text-info">( <?= lang("employee_id") . ', ' . lang("absent_days"). ', ' . lang("holiday_allowance_hours"); ?>
