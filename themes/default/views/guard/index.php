<script>
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= site_url('guard/getGuard') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('guards'); ?></h2>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('designation'); ?></th>
                            <th class="col-xs-1"><?php echo lang('phone'); ?></th>
                            <th class="col-xs-2"><?php echo lang('Date OF Birth'); ?></th>
