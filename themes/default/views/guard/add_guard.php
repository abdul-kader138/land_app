    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php echo form_input('dob', (isset($_POST['dob']) ? $_POST['dob'] : ''), 'class="form-control date" required="required"  id="dob"'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <?php echo lang('joining_date', 'joining_date'); ?>
                                <div class="controls">
                                    <?php echo form_input('joining_date', (isset($_POST['joining_date']) ? $_POST['joining_date'] : ''), 'class="form-control date" required="required" id="joining_date"'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <?= lang('status', 'status'); ?>
                ...
                <p><?php echo form_submit('add_guard', lang('add_guard'), 'class="btn btn-primary"'); ?></p>
